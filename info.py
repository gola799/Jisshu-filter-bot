...
USERNAME = environ.get('USERNAME', "https://t.me/Junglekirani") # ADMIN USERNAME
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/moviesearchgroup25') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
